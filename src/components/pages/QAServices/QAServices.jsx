...
that a human tester can’t see, while avoid the variables that comes with manual testing.</p>
    ...
    <div class="card">
      <img src={img2} class="card-img-top"
        alt="Hollywood Sign on The Hill" />
          <div class="card-body">
                <h5 class="card-title s-subtitle">Card title</h5>
                <p class="card-text q-services">An organization can use performance testing as a diagnostic aid to locate computing or communications bottlenecks within a system. Bottlenecks are a single point or 
                component within a system's overall function that holds back overall performance.</p>
            </div>
    </div>
    </div>
    <div class="col">
